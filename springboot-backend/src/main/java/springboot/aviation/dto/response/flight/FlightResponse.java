package springboot.aviation.dto.response.flight;

import springboot.aviation.domain.flight.Flight;
import springboot.aviation.dto.response.summary.AirlineSummaryResponse;
import springboot.aviation.dto.response.summary.AirportSummaryResponse;
